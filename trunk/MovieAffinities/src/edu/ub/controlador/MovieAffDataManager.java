...
public class MovieAffDataManager {
     ...
     */
    public void crearClient(int id, String nom, String dni, String adreca,
            String usuari, String password, boolean vip, int faltes) {

        /* TODO: Creeu aqui el vostre client
         */

        Client cliente = new Client(id, nom, usuari, dni, adreca, password, vip, faltes);
